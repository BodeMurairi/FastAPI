...
if os.getenv("CRYPTID_UNIT_TEST"):
    from fake.user import user as data
else:
    from data.user import user as data
...
def auth_user(name: str, plain: str) -> User | None:
    """Authenticate user <name> and <plain> p"""
...
def create_access_token(data: dict,
 expires: timedelta | None = None
    ...
    if not expires:
        ...
        encoded_jwt = jwt.encode(src, SECRET_KEY, algorithm=os.getenv("ALGORITHM"))
        return encoded_jwt
